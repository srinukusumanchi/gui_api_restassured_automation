...
package bns.a6.microui.web.pages.bgx4.customerInformation;

import bns.a6.microui.web.constants.FrameworkConstants;
import bns.a6.microui.web.enums.WaitStrategy;
import bns.a6.microui.web.pages.intralink.IntraLinkHomePage;
...
public final class PopUps  extends BasePage {
     ...
     */
    public IntraLinkHomePage clickLeave() {
        acceptAlert();
