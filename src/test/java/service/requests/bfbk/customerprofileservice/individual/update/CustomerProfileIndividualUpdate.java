 ...
 * Created Time: 2:04 p.m.
 */

package service.requests.bfbk.customerprofileservice.individual.update;
...
public class CustomerProfileIndividualUpdate {

    // Personal customer Update request body - Customer Profile
    public String generateCustomerUpdateRequest(ResultSet resultset) throws SQLException, JsonProcessingException {

//        customer_basic_information block
        Customer_basic_information customer_basic_information = new Customer_basic_information();
        customer_basic_information.setCustomer_key(resultset.getString("customer_key"));
